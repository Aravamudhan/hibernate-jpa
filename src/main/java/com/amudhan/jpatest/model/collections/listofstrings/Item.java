 ...
 * When an image value is deleted, hibernate issues one delete and 2 update queries.
 * These two queries are fired to update the positions of other elements.
 * When an item is deleted in a list, two items before and after that need to be updated.*/
...
public class Item extends AbstractItem{
	...
	@OrderColumn(name="ITEM_ORDER")//Stores an index in the persistent list starting at 0.
